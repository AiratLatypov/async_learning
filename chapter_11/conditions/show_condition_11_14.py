...
# Infinite output
# Work finished, lock released.
# Waiting for condition lock...
# Acquired lock, releasing and waiting for condition...
# Acquired lock, releasing and waiting for condition...
# About to notify, acquiring condition lock...
# Lock acquired, notifying all workers.
# Notification finished, releasing lock.
# Condition event fired, re-acquiring lock and doing work...
# Work finished, lock released.
# Waiting for condition lock...
# Condition event fired, re-acquiring lock and doing work...
# Work finished, lock released.
