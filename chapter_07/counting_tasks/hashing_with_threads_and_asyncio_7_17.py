...
# выполняется <function main at 0x000002BE1C9DB420> с аргументами () {}
# <function main at 0x000002BE1C9DB420> завершилась за 6.6713 сек
# получается вариант с потоками отработал почти в 6 раз быстрее
